...
다음 장부터는 **공격을 성공시킨 후 일반 사용자 영역으로 안전하게 돌아오는(Graceful Return) 방법을 배웁니다.** 이제 진짜 해커가 될 시간입니;다!

### 덧붙이는 말

물론 현실의 운영체제 해킹이 이렇게 쉽지는 않습니다. 리누스 토르발즈를 포함한 전 세계 최고의 개발자들은 해커들이 이렇게 쉽게 시스템을 장악하지 못하도록 강력한 보안 장치(KASLR, SMEP, SMAP 등)들을 도입해 두었습니다. (이번 1장에서는 여러분의 이해를 돕기 위해 모든 보안 장치를 꺼둔 상태였습니다.)

이후 장에서는 이 보안 장치들이 어떻게 동작하는지 이해하고, 이것을 하나씩 우회하는 방법을 배워보겠습니다!