...
![module](../images/Chapter_1/image.png)
...
![device](../images/Chapter_1/image-1.png)
...
소스 코드가 있는 폴더에 `Makefile`이라는 이름으로 새 파일을 만들고 아래 코드를 작성해 주세요. (첫 글자 M은 반드시 대문자여야 합니다!)
...
![log](../images/Chapter_1/image-2.png)
